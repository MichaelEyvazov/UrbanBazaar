...
MAIL_FROM=UrbanBazaar <noreply@yourdomain.com>
...
Frontend: `https://urbanbazaar.vercel.app`  
Backend API: `https://urbanbazaar-api.onrender.com`  
*(Add links when deployed)*
